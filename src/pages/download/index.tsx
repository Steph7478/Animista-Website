...
export default function Download() {
  ...
  return (
    <div className="overflow-hidden bg-white font-text text-navbar sm:p-5 md:px-[15%] md:py-[10%]">
      {currentFavs.length === 0 ? (
        ...
        <>
          ...
          <div className="my-[40px]">
            <span className="sm:text-[20px] md:text-[30px]">
          ...
          <div className="mt-[40px] flex flex-col">
            ...
            <span className="mt-[25px] sm:text-sm md:text-base">
