...
export default function Privacy() {
  ...
  return (
    <div className="sm:text-md flex flex-col overflow-hidden bg-white font-text text-navbar sm:p-5 md:px-[15%] md:py-[10%] md:text-lg">
      ...
      <Section title="Information Collection and Use" className="">
        ...
        <SubSection title="Personal Data" className="">
          ...
          <br />
          <ul className="flex translate-x-[10%] list-disc flex-col gap-y-3 sm:text-sm md:text-base">
            <li>Email address</li>
            <li>Cookies</li>
            <li>Usage Data</li>
          </ul>
...
function Section({ title, children, className }: SectionProps) {
  return (
    <div className="mt-8">
      <h2
        className={`${className} my-[35px] font-normal sm:text-[20px] md:text-[30px]`}
      >
        {title}
      </h2>
      {children}
...
function SubSection({ title, children, className }: SectionProps) {
  return (
    <div className="my-10">
      <h3
        className={`${className} my-5 font-normal sm:text-[15px] md:text-[25px]`}
      >
        {title}
      </h3>
      {children}
