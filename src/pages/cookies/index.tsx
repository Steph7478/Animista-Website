...
export default function Cookies() {
  ...
  return (
    <div className="flex flex-col overflow-hidden bg-white font-text text-lg text-navbar sm:p-5 md:px-[15%] md:py-[10%]">
      <Modal toggleModal={toggleModal} modal={modal} />
      <Section
        title="Cookies Policy"
        className="mb-[80px] font-normal uppercase sm:text-[45px] md:text-[60px]"
      >
      ...
      >
        ...
        <br />
        <ul className="flex translate-x-[10%] list-disc flex-col gap-y-3 text-lightred marker:text-navbar sm:text-sm md:text-base">
          <li>
            {" "}
            <a
              target="_blank"
...
function Section({ title, children, className }: SectionProps) {
  return (
    <div className="my-8">
      <h2
        className={`${className} mb-[30px] font-normal sm:text-[20px] md:text-[30px]`}
      >
        {title}
      </h2>
      {children}
