...
export default function HowTo() {
  ...
  return (
    <div className="flex flex-col items-start justify-center bg-white font-text text-navbar sm:p-5 md:px-[15%] md:py-[10%]">
      ...
      <Section title="Few notes">
        <p className="mb-[100px] pt-4 sm:text-sm md:text-base">
...
function Section({
  ...
  return (
    <div>
      <span className="mt-14 sm:text-[45px] md:text-[50px]">{title}</span>
      {children}
    </div>
  );
}
  ...
  return (
    <div className="my-14 flex flex-row">
      ...
      <div className="px-6">
        ...
        <p className="mt-4 sm:text-sm md:text-base">{description}</p>
      </div>
    </div>
  );
}
