...
export default function About() {
  ...
  return (
    <div className="font-text">
      <div className="flex flex-col bg-white text-navbar sm:p-5 md:px-[170px] md:py-[80px]">
        <span className="uppercase sm:text-[40px] md:text-[50px]">About</span>
        <span className="py-5 uppercase sm:text-sm md:text-lg">
        ...
        <span className="py-5 sm:text-[40px] md:text-[50px]">Get in touch</span>
        <p className="mb-16 sm:text-sm md:text-base">
