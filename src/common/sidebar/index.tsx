  ...
  return (
    <div>
      ...
      <div>
        ...
        ></div>
        <div
          className={`fixed bottom-0 right-0 z-40 flex h-full bg-white shadow-md shadow-black transition-transform duration-500 ease-out sm:w-full md:w-[50%] ${
          ...
          <div className="relative m-[46px] flex h-[85%] w-full flex-col items-center justify-start border-[1px] border-gray-400 p-16">
            ...
            <div>
              ...
              <a target="_blank" href={"/https://x.com/cssanimista"}>
                {" "}
                <FaTwitter className="mt-3 h-9 w-9 justify-self-center invert transition-all duration-300 ease-in-out hover:scale-110" />
              </a>
            </div>
          </div>
        </div>
