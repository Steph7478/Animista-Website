...
export default function Footer() {
  return (
    <div className="w-full overflow-hidden border-t-[1px] bg-transparent">
      <div className="relative -bottom-3 mx-auto flex w-fit items-center justify-center">
        <span className="flex w-full items-center justify-center text-nowrap rounded-t-sm bg-white px-3 py-1 text-xs font-bold uppercase text-gray-500 sm:hidden md:flex">
          Premium sponsors
        </span>
      </div>

      <div className="flex flex-wrap items-center justify-center gap-10 border-y-[1px] border-gray-300 bg-white py-[30px] sm:hidden md:flex">
        <img
